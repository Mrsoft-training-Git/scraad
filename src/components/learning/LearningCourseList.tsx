...
import { BookOpen, CheckCircle2, PlayCircle, RotateCcw, CreditCard, Search } from "lucide-react";
...
export const LearningCourseList = ({ courses, loading, paymentLoading }: Props) => {
        ...
        <Card className="border border-border/60 shadow-none">
          <CardContent className="py-16 text-center">
            ...
            <p className="text-muted-foreground text-sm mb-4">
              {courses.length === 0 ? "Start your learning journey today" : "Try adjusting your filters"}
            </p>
            {courses.length === 0 && (
