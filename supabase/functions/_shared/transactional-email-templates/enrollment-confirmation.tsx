...
const Email = ({
  ...
  <EmailLayout
    ...
    detailsBody={
      <>
        {startDate && <Text style={detailLine}><strong>Starts:</strong> {startDate}</Text>}
        {mode && <Text style={detailLine}><strong>Mode:</strong> {mode}</Text>}
        <Text style={detailLine}><strong>Status:</strong> Confirmed</Text>
      </>
    }
